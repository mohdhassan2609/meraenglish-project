        ...
        <div id="content">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div id="demo" class="dashboard_container">
                                                                        ...
                                                                        <div class="bb-video-box">
                                                                            <div class="bb-video-box-inner">
                                                                                <div class="bb-video-box-innerup">
                                                                                    <a href="<?= base_url() ?>my-courses-video-page/<?= $video->id ?>/<?= $video_count ?>" class="theme-cl"><i class="ti-link"></i></a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="edu_duration"><?= $details->duration; ?></div>
                                                            </div>
                                                                                                                            ...
                                                                                                                            <div class="thumb">
                                                                                                                                ...
                                                                                                                                <div class="overlay_icon">
                                                                                                                                    <div class="bb-video-box">
                                                                                                                                        <div class="bb-video-box-inner">
                                                                                                                                            <div class="bb-video-box-innerup">
                                                                                                                                                <a href="<?= base_url() ?>my-courses-video-page/<?= $video->id ?>/<?= $video_count ?>" class="theme-cl"><?= $url->title ?></a>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                </div>
