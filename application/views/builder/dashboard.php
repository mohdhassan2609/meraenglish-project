            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- end page title --> 
                         <?php $property_ids=$this->common_model->get_records('tbl_property_details', "status='0' and builders_info_id='$record->id'");?>
                         <?php $count=0;?>
                            <?php foreach($property_ids as $property_id):?>

                                <?php $viewed=$this->common_model->get_custom_query("select COUNT(id) as count from tbl_user_wishlist where status='0' and item_id='$property_id->id'");
                        ...
                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Wishlist</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="widget-rounded-circle card-box">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?=count($property_ids)?></span></h3>
                                                <p class="text-muted mb-1 text-truncate">Total Property</p>
                                            </div>
                                        </div>
                                    </div></a> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                            ...
                            <?php foreach($property_ids as $property_id):
                               ?>
                                ...
                                <?php $view=$this->common_model->get_custom_query("select COUNT(id) as count from tbl_enquiry where status='0' and item_id='$property_id->id'");
                                 $count+=$view[0]->count;
                                ?>
                            <?php endforeach;?>
                            ...
                            <?php foreach($property_ids as $property_id):?>
                                ...
                                <?php $viewed=$this->common_model->get_custom_query("select COUNT(id) as count from tbl_recently_viewed where status='0' and item_id='$property_id->id'");
                                 $count+=$viewed[0]->count;?>
                            <?php endforeach;?>
                            <div class="col-md-6 col-xl-3">
                                <div class="widget-rounded-circle card-box">
