                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" value="tbl_media_coverage" name="table_name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="desktop_image">Image</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="link" placeholder="http:// or https://">
                                            <span class="text-danger error-span">This input is required.</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                ...
                                <tr>
                                    ...
                                    <th data-field="createdob" data-sortable="true">Created Date/Time</th>
                            ...
                            <tbody>
                                ...
                                if (!empty($records)) {
                                    ...
                                    foreach ($records as $record) {
                                        ...
                                        <tr>
                                            <td><?php echo $inc; ?></td>
                                            <td><img src="<?= base_url() ?>uploads/common/<?php echo $record->image ?>" style="width: 50px; height: 50px;"></td>
                                            <td><?php echo $record->title ?></td>
                                            <td><?php echo word_limiter($record->link, 5) ?></td>
                                            <?php
                                            ...
                                            <td class="text-center">
                                                <?php if ($record->id != 0): ?>
                                                    ...
                                                    <a class="btn btn-sm btn-danger deletecats <?= $record->id; ?>" onclick="myFunction(this,<?= $record->id; ?>, 'tbl_media_coverage')"
                                                       style="<?php
                                                       if ($record->status == 1) {
                                                           echo 'display: none;';
                                                       }
                                                       ?>" href="#" data-table="tbl_media_coverage" data-id="<?php echo $record->id; ?>"><i class="fa fa-times"></i></a>
                                                   <?php endif; ?>
                                            </td>
            ...
            <form reload-action="true" this_id="form-002" class="update_data" method="post" role="form">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="text_content">Image</label>
                                <input type="file" class="form-control" name="image">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="description">Link</label>
                                <input type="text" class="form-control" rows="5" name="link">
                            </div>
                        </div>
                    </div>
                </div>
