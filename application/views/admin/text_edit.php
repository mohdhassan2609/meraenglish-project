...
<!--                                    <label>Course Name<span class="text-danger">*</span></label>-->
                                    ...
                                    <input type="hidden" class="form-control required" name="course_id" value="<?= $id ?>">
                                    <input type="hidden" class="form-control required" name="video_id" value="<?=($curriculum->id == "")?"new":$curriculum->id?>">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control required" name="curriculum" value="<?= $curriculum->curriculum ?>" required>
                                    <span class="text-danger error-span">This input is required.</span>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control required" name="curriculum_title" value="<?= $curriculum->curriculum_title ?>">
                                    <span class="text-danger error-span">This input is required.</span>
