                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Newsletter Subscription</a></li>
                                ...
                                <tr>
                                 ...
                                 $datetime = new DateTime($myvalue);
                                  ...
                                  ?>
                                    ...
                                    <!--    <?php endif; ?>-->
                                        <a class="btn btn-danger deletecats <?= $record->id;?>" onclick="myFunction(this,<?= $record->id;?>,'tbl_newsletter')"
                                            style="<?php if($record->status == 1){ echo 'display: none;'; } ?>"
                                            data-table="tbl_newsletter" data-id="<?php echo $record->id; ?>"><i
